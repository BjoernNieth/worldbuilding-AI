...
class Mistral_Model(Base_Model):
    def __init__(self, model_name, model_args, output_dir):
        ...
        print("Mistral like model is being downloaded from Hugging Face Hub. This may take a while...")
    ...
    def __remove_prefix_flags(self, prompts):
        ...
        This is necessary to avoid issues with a prefix flag which occurs not as the last message in the prompt for Mistral models.
        """
        cleaned_prompts = []
